...
#SBATCH --output=/scratch/dlevenst/sbatch_out/theta_hyperparm_panel.%A.%a.out  #compute canada
#SBATCH --job-name=theta_hyperparm_panel
...
# #SBATCH --output=/network/scratch/d/daniel.levenstein/sbatch_out/theta_hyperparm_panel.%A.%a.out
# #SBATCH --job-name=theta_hyperparm_panel
